...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <form method="POST" action="input" enctype="multipart/form-data">
        ...
        Id Kategori<br/><input type="text" name="id_kategori" size="130" maxlength="10" value="<?php if(isset($data)) { echo $data[0]->id_kategori; } ?>"><br/><br/>

        Nama Kategori <br/><input type="text" name="nama_kategori" size="130" maxlength="10" value="<?php if(isset($data)) { echo $data[0]->nama_kategori; } ?>"><br/><br/>
