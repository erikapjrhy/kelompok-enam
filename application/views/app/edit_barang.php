  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
           ...
           <h2> <p align="center"> Update Data Barang </p> </h2>
          <!-- Page Heading -->
    ...
    <form method="post" action="<?php echo base_url()?>Auth/update" enctype="multipart/form-data">
        ...
        echo '<select class="form-control" name="id_kategori">';
          foreach ($id_kategori as $rows) {
            if ($rows->id_kategori==$user[0]['id_kategori']) {
              echo '<option value="'.$rows->id_kategori.'"selected="selected">'.$rows->id_kategori.'</option>';
              # code...
            }else{
              echo '<option value="'.$rows->id_kategori.'">'.$rows->id_kategori.'</option>';
            }
          }
          echo '</select>';
        ?>
